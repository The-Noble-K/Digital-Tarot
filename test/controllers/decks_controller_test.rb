...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { card_name: @deck.card_name, image: @deck.image, meaning: @deck.meaning, reversal: @deck.reversal } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { card_name: @deck.card_name, image: @deck.image, meaning: @deck.meaning, reversal: @deck.reversal } }
